...
class AttnDecoderRNN(nn.Module):
    def __init__(self, attn_model, hidden_size, output_size, n_layers=1, dropout_p=0.1, embeddings=None):
        super(AttnDecoderRNN, self).__init__()
        ...
        self.gru = nn.GRU(embeddings.shape[1]+hidden_size, hidden_size, n_layers, dropout=dropout_p)
